...
Feature: Delete Flights
  ...
  Scenario: Delete Departure

  Aim of this test is to ensure that when a Delete Departure message is sent via the Ultra client, the flight is created succesfully in the AODB
    ...
    When the client sends a "DeleteDeparture":
      """
<AFUSRequest xsi:schemaLocation="http://request.afus.schema.ultra-as.com AFUSRequest.xsd" xmlns:com="http://common.schema.ultra-as.com" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:req="http://request.afus.schema.ultra-as.com" xmlns:head="http://header.schema.ultra-as.com">
      <req:Envelope>
         ...
         <req:Body>
            <req:AFUSRequest>
               ...
               <req:RequestType>Delete</req:RequestType>
   ...
   """
    ...
    Then the flight doesn't exist in the AODB
